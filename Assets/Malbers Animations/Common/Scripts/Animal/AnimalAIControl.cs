       ...
       // protected Animal TisAnimal;          //To check if the target is an animal
        ...
        void Update()
        {
            ...
            else if (AgentActive)                                               //if we are on a NAV MESH onGround
            {
                ...
                if (IsWaiting) return;                                          //If the Animal is Waiting do nothing . .... he is doing something else... wait until he's finish
        ...
        /// <summary>
        /// Updates the Agents using the animation root motion
        /// </summary>
